...
// >>>>>>>>>>>>>>>>>>>>>>>>> demo轮播图1 >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    cycleScrollView.pageControlStyle = SDCycleScrollViewPageControlStyleAnimated;
...
// >>>>>>>>>>>>>>>>>>>>>>>>> demo轮播图2 >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    cycleScrollView2.pageControlAliment = SDCycleScrollViewPageControlAlimentRight;
